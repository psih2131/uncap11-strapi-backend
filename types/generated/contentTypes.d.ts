...
export interface ApiLeadsAgencyLeadsAgency extends Struct.CollectionTypeSchema {
  collectionName: 'leads_agencies';
  info: {
    displayName: 'leads-agency';
    pluralName: 'leads-agencies';
    singularName: 'leads-agency';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiLeadsPayStatusLeadsPayStatus
  ...
  info: {
    displayName: 'leads-pay-status';
    pluralName: 'leads-pay-statuses';
    singularName: 'leads-pay-status';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    full_info: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::leads-pay-status.leads-pay-status'
    > &
      Schema.Attribute.Private;
    order_description: Schema.Attribute.Text;
    pay_address: Schema.Attribute.String;
    pay_amount: Schema.Attribute.String;
    pay_currency: Schema.Attribute.String;
    payment_id: Schema.Attribute.UID;
    payment_status: Schema.Attribute.String;
    price_amount: Schema.Attribute.String;
    price_currency: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLeadsSingUpLeadsSingUp extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'leads-sing-up';
    pluralName: 'leads-sing-ups';
    singularName: 'leads-sing-up';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::leads-sing-up.leads-sing-up'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
